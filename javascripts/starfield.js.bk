...
letter.append('path').attr('class','constellationFill').attr('d','m-300 -10 l0 -100 l50 100 l50 -100 l0 100').attr('id','M');

/*A*/letter.append('path').attr('class','constellationLines').attr('d','m-190 -10 l45 -100 l45 100').attr('id','A');
letter.append('path').attr('class','constellationFill').attr('d','m-190 -10 l45 -100 l45 100').attr('id','A');

/*U*/letter.append('path').attr('class','constellationLines').attr('d','m-90 -110 l0 100 l80 0 l0 -100').attr('id','U');
letter.append('path').attr('class','constellationFill').attr('d','m-90 -110 l0 100 l80 0 l0 -100').attr('id','U');

/*R*/letter.append('path').attr('class','constellationLines').attr('d','m10 -10 l0 -100 l40 0 l30 30 l-30 30 l-40 0 l70 40').attr('id','R');
letter.append('path').attr('class','constellationFill').attr('d','m10 -10 l0 -100 l40 0 l30 30 l-30 30 l-40 0 l70 40').attr('id','R');
...
letter.append('path').attr('class','constellationFill').attr('d','m210 -110 l-80 50 l80 50').attr('id','C');
...
letter.append('path').attr('class','constellationFill').attr('d','m-115 10 l50 20 l0 60 l-50 20 l-50 -20 l0 -60 l50 -20').attr('id','O1');

/*O*/letter.append('path').attr('class','constellationLines').attr('d','m0 10 l50 20 l0 60 l-50 20 l-50 -20 l0 -60 l50 -20').attr('id','O2');
letter.append('path').attr('class','constellationFill').attr('d','m0 10 l50 20 l0 60 l-50 20 l-50 -20 l0 -60 l50 -20').attr('id','O2');

/*D*/letter.append('path').attr('class','constellationLines').attr('d','m65 10 l0 100 l60 0 l40 -50 l-40 -50 l-60 0').attr('id','D');
letter.append('path').attr('class','constellationFill').attr('d','m65 10 l0 100 l60 0 l40 -50 l-40 -50 l-60 0').attr('id','D');

/*S*/letter.append('path').attr('class','constellationLines').attr('d','m245 10 l-70 25 l100 50 l-70 25').attr('id','S');
letter.append('path').attr('class','constellationFill').attr('d','m245 10 l-70 25 l100 50 l-70 25').attr('id','S');
